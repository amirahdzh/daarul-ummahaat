        ...
        <div class="md:flex md:items-center md:justify-between">
          <div class="flex-1 min-w-0">
            <h1 class="text-3xl font-bold text-gray-900">
              Program Daarul Ummahaat
            </h1>
            <p class="mt-2 text-gray-600">
              Berbagai program pendidikan dan sosial untuk ummah
            </p>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="data?.data" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
          <p class="text-gray-600">
            ...
            {{ data.meta?.total || data.data.length }} program
          </p>
      ...
      <div v-else class="text-center py-12">
        <div class="max-w-md mx-auto">
          ...
          <p class="text-gray-600">
            Program akan ditampilkan di sini ketika sudah tersedia.
          </p>
        </div>
      </div>
    </div>
  ...
  meta: [
    {
      name: "description",
      content:
        "Berbagai program pendidikan dan sosial untuk ummah di Daarul Ummahaat",
    },
  ],
});
</script>
